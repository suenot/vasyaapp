                ...
                {showMenu && (
                  <div className="chat-options-menu">
                    <button className="chat-options-menu-item" onClick={() => { onShowInfo?.(); setShowMenu(false); }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M3 5h12M9 3v2M5 5c1 5 4 8 8 10M13 5c-1 5-4 8-8 10M14 21l4-10 4 10M16 17h4" /></svg>
                      {t('translation_title')}
                    </button>
                    <button className="chat-options-menu-item" onClick={() => { onShowInfo?.(); setShowMenu(false); }}>
